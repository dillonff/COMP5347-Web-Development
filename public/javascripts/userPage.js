...
function initialize() {
  axios
    .get('http://localhost:3000/entry/userPage/getUserId')
...
function loadUserPage() {
  ...
  const reqUrlone =
    'http://localhost:3000/entry/userPage/getUserInfo/' + userId;
  getRequest(
  ...
  getRequest(
    'http://localhost:3000/entry/userPage/changeImageRoutes/hellochangeimage', //change db image routes
    function(data) {
  ...
  let reqUrltwo =
    'http://localhost:3000/entry/userPage/phoneListings/' + userId; //get related phone listings
  axios
    .get(reqUrltwo)
    .then(function(response) {
...
function updateProfile() {
  ...
  if (initialPwd == null) {
    ...
    axios
      .post('http://localhost:3000/entry/userPage/checkPwd', pwd)
      .then(function(response) {
        console.log('pppppppppppwwwwwwwwwwwwwwwddddddddddd', response);
        if (response.data == 'correctpwd') {
          axios
            .post('http://localhost:3000/entry/userPage/updateUserInfo', data)
            .then(function(response) {
...
function changePassword() {
  ...
  if (curPasswordInitial == '') {
    ...
    axios
      .post('http://localhost:3000/entry/userPage/checkPwd', curPassword)
      .then(function(response) {
        ...
        if (response.data == 'correctpwd') {
          ...
          axios
            .post('http://localhost:3000/entry/userPage/userInfo/pwd', data)
            .then(function(response) {
              console.log(response);
...
function addNewListing() {
  ...
  if (!isNumber(newStock) || !isNumber(newPrice)) {
    ...
    let data =
      ...
      userId;
    axios
      .post('http://localhost:3000/entry/userPage/userInfo/newlisting', data)
      .then(function(response) {
        console.log(response);
...
function saveChanges() {
  ...
  function postDisableReq() {
    return axios.post(
      'http://localhost:3000/entry/userPage/disablePhoneListings',
      disableInfo
    );
  }
  function postNotDisableReq() {
    return axios.post(
      'http://localhost:3000/entry/userPage/notDisablePhoneListings',
      notDis
    );
  }
  ...
  function postDeleteReq() {
    return axios.post(
      'http://localhost:3000/entry/userPage/deletePhoneListings',
      deleteInfo
    );
  }
